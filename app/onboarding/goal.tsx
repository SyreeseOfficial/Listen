...
const OPTIONS = [
  { key: 'relaxation', icon: '🧘', label: 'Relaxation', sub: 'Music as rest and escape' },
  { key: 'appreciation', icon: '👂', label: 'Deeper appreciation', sub: "Hear things I've been missing" },
  { key: 'habit', icon: '📖', label: 'Build a habit', sub: 'Track and grow my listening' },
  { key: 'disconnect', icon: '🔇', label: 'Disconnect', sub: 'Step away from the noise' },
];
...
export default function GoalScreen() {
  ...
  async function next() {
    if (!selected) return;
    await updateProfile({ listeningGoal: selected });
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.sub, { color: colors.textSecondary }]}>Choose what matters most to you.</Text>
      </View>
